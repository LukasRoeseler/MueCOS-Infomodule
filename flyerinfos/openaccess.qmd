...
-   [*OA flyer*](https://github.com/LukasRoeseler/MueCOS-Infomodule/blob/main/flyerinfos/OA_flyer.pdf)

-   [*OA cheat sheet*](https://github.com/LukasRoeseler/MueCOS-Infomodule/blob/main/flyerinfos/OA_cheatsheet.pdf)
:::
...
3.  Further resources such as the [DOAJ](https://doaj.org/search/journals?ref=homepage-box&source=%7B%22query%22%3A%7B%22query_string%22%3A%7B%22query%22%3A%22Frontiers%22%2C%22default_operator%22%3A%22AND%22%2C%22default_field%22%3A%22bibjson.publisher.name%22%7D%7D%2C%22track_total_hits%22%3Atrue%7D) (has a very low bar for journals to be indexed) or the website [Predatory Journals](https://www.predatoryjournals.org) (has anonymous authors and intransparent rating systems) may provide additional insights.

## **The Prisoner's Dilemma of Publishing**

In many fields, established and prestigious journals are owned by commercial journals and - although researchers are usually members of the editorial board - they can be pressured by the publisher to lower quality standards. This has led to conflicts and [resignations of entire editorial boards](https://retractionwatch.com/the-retraction-watch-mass-resignations-list/). In other words, early career researchers' [academic success can rely on publications](https://doi.org/10.1177/1745691612459060) in [prestigious and expensive](https://doi.org/10.1162/qss_a_00015) journals. For example, a publication in the prestigious journal *Nature Human Behavior* costs more than € 10,000.00. Researchers may arrive at the decision between a low-prestige diamond OA journal and a high-prestige gold OA (or closed access) journal. Institutions are currently revising their research evaluation (e.g., [SF DORA](#0), [CoARA](#0)) but are relatively likely to reward publications in high impact journals over open access publications.
