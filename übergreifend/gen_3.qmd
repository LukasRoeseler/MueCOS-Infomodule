...
![Vereinfachte Beschreibung der Kostenaufteilung je nach Publikationstyp. Diese Darstellung enthält nicht alle denkbaren Varianten. Wenden Sie sich in spezifischen Fällen an die Open Access Beauftragten der Universität.\
DFG: Deutsche Forschungsgemeinschaft\
MPDL: Max Planck Digital Library\
\*Eine Übersicht über Vereinbarungen mit verschiedenen Zeitschriften ist online verfügbar: <https://www.uni-muenster.de/Publizieren/open-access/wwu/verlage.html>](/img/werzahlt.jpg){.lightbox}
...
-   Interaktiver und lebendiger Datensatz zu Publikationskosten deutscher Institutionen: <https://treemaps.openapc.net/apcdata/openapc/> bzw. [Daten von Münster](https://treemaps.openapc.net/apcdata/muenster-u/)
